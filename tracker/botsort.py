...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score, feat=None, feat_history=3):
...
class BoTSORT(object):
    ...
    def update(self, bboxes, scores, classes, img):
        self.frame_id += 1
        activated_starcks = []
        refind_stracks = []
        lost_stracks = []
        ...
        #Shu joyini tekshirish kere: not args.mot20 bo'ganda ishlidi
